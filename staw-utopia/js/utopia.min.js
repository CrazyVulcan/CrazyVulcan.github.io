...
module.filter("shipCardNamed", ["$filter", function (a) {
	...
	return {
		...
		"ship:enterprise_d_2017core":{
			intercept: {
				ship: {
					factionPenalty: function (a, b, c, d) {
					return h(a, "vulcan", b, c) ? 0 : d
					}	
				},
				ship: {
					factionPenalty: function (a, b, c, d) {
					return h(a, "bajoran", b, c) ? 0 : d
					}	
				}
			}
		},
		...
		"captain:2008": {
			intercept: {
				...
				ship: {
					factionPenalty: function (a, b, c, d) {
					return h(a, "ferengi", b, c) ? 0 : d
					}	
				},
				ship: {
					factionPenalty: function (a, b, c, d) {
					return h(a, "kazon", b, c) ? 0 : d
					}	
				},
				ship: {
					factionPenalty: function (a, b, c, d) {
					return h(a, "xindi", b, c) ? 0 : d
					}	
				}
			}
		},

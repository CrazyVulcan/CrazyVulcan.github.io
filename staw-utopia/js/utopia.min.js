...
module.filter("shipCardNamed", ["$filter", function (a) {
	...
	//Krayton
		"captain:2026":{
			factionPenalty: function (a, c, d) {
				return c && b.hasFaction(c, "independent", c, d) ? 0 : 1 && b.hasFaction(c, "kazon", c, d) ? 0 : 1 && b.hasFaction(c, "xindi", c, d) ? 0 : 1
			}
		},
		"talent:3060":{
			factionPenalty: function (a, c, d) {
	...
	//USS Defiant
		"captain:2030":{
			factionPenalty: function (a, c, d) {
				return c && b.hasFaction(c, "vulcan", c, d) ? 0 : 1 && b.hasFaction(c, "federation", c, d) ? 0 : 1
			}
		},
		"captain:2029":{
			factionPenalty: function (a, c, d) {
	...
	//Nistrim Raider
		"captain:rettik_71282":{
			factionPenalty: function (a, c, d) {
				return c && b.hasFaction(c, "ferengi", c, d) ? 0 : 1 && b.hasFaction(c, "independent", c, d) ? 0 : 1 && b.hasFaction(c, "xindi", c, d) ? 0 : 1
			}
		},
	...
	//D'Kyr
		"captain:tavek_71446":{
			factionPenalty: function (a, c, d) {
				return c && b.hasFaction(c, "federation", c, d) ? 0 : 1 && b.hasFaction(c, "bajoran", c, d) ? 0 : 1
			},
			upgradeSlots: [{
				type: ["crew"]
			}]
	...
	//Soong
		"captain:hugh_71522":{
			factionPenalty: function (a, c, d) {
				return c && b.hasFaction(c, "ferengi", c, d) ? 0 : 1 && b.hasFaction(c, "kazon", c, d) ? 0 : 1 && b.hasFaction(c, "xindi", c, d) ? 0 : 1 && b.hasFaction(a, "borg", c, d) ? 0 : e
			},
			intercept: {
				ship: {
					cost: function (a, b, c, d) {
	...
	//USS Raven
		"captain:magnus_hansen_71509":{
			factionPenalty: function (a, c, d) {
				return c && b.hasFaction(c, "ferengi", c, d) ? 0 : 1 && b.hasFaction(c, "kazon", c, d) ? 0 : 1 && b.hasFaction(c, "xindi", c, d) ? 0 : 1 && b.hasFaction(c, "federation", c, d) ? 0 : 1
			}
		},
	...
	//Val Jean
		"captain:calvin_hudson_71528":{
			...
			intercept: {
				ship: {
					cost: function (a, c, d, e) {
						return b.hasFaction(c, "independent", c, d) && f(a) ? g(a, c, d, e) - 1 : e && b.hasFaction(c, "ferengi", c, d) && f(a) ? g(a, c, d, e) - 1 : e && b.hasFaction(c, "kazon", c, d) && f(a) ? g(a, c, d, e) - 1 : e && b.hasFaction(c, "xindi", c, d) && f(a) ? g(a, c, d, e) - 1 : e
					}
				}
			}
		},
	...
	//IKS Pagh
		"crew:william_t_riker_71996":{
			factionPenalty: function (a, c, d) {
				return c && b.hasFaction(c, "vulcan", c, d) ? 0 : 1 && b.hasFaction(c, "bajoran", c, d) ? 0 : 1 && b.hasFaction(c, "klingon", c, d) ? 0 : 1
			},
			upgradeSlots: [{
				type: ["talent"]
			}],
	...
	//USS Lakota
		...
		"weapon:upgraded_phasers_blind_lakota":{
			...
			canEquip: function (a, b, c) {
				return b.attack <= 3 ? d("Upgraded Phasers")(a, b, c) : !1
			},
			intercept: {
				self: {
					cost: function (a, b, c, d) {
	...
	//Orassin
		...
		"crew:insectoid_raiding_party_orassin":{
			...
			rules: "Only one per ship",
			canEquip: d("Insecetoid Raiding Party")
		},
		"weapon:pulse-firing_particle_cannon_orassin":{
			...
			intercept: {
				self: {
					cost: function (a, c, d, e) {
						return c && !b.hasFaction(c, "xindi", c, d) ? g(a, c, d, e) + 5 : e
					}
				}
			}
		},

angular.module('utopia').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('search.html',
    ...
    "\t\t\t<div class=\"u-search-filter-comment\">\r" +
    "\n" +
    "\t\t\t\tFilter On Maneuver: \r" +
    "\n" +
    "\t\t\t\t<select ng-model=\"search.maneuverType\"><option value=\"\">Any</option><option ng-repeat=\"maneuver in maneuvers\" value=\"{{maneuver.value}}\">{{maneuver.name}}</option></select>\r" +
    "\n" +
    "\t\t\t\t<select ng-model=\"search.maneuverSpeed\"><option value=\"\">Any</option><option ng-repeat=\"speed in speed_list\" value=\"{{speed.value}}\">{{speed.name}}</option></select>\r" +
    "\n" +
  ...
  $templateCache.put('card-ship-class.html',
    ...
    "\n" +
    "\t<div ng-class=\"(shipClass.id == 'borg_cube') ? 'card-image-large' : 'card-image'\"></div>\r" +
    "\n" +
    "\r" +
    "\n" +
    ...
    "\r" +
    "\n" +
    "\t<div ng-class=\"(shipClass.id == 'borg_cube') ? 'card-border-left-tall pull-left' : 'card-border-left pull-left'\"></div>\r" +
    "\n" +
    "\r" +
    "\n" +
    "\t<div ng-class=\"(shipClass.id == 'borg_cube') ? 'card-border-right-tall pull-right' : 'card-border-right pull-right'\"></div>\r" +
    "\n" +
    "\r" +
    "\n" +
    "\t<div ng-class=\"(shipClass.id == 'borg_cube') ? 'card-class-maneuvers-tall' : 'card-class-maneuvers'\">\r" +
    "\n" +
  ...
  $templateCache.put('card-upgrade.html',
    "<div class=\"card-outer card-upgrade font-staw\" ng-class=\"{ 'card-unique': upgrade.unique, 'card-specialization': upgrade.specialization, 'card-OnePerShip': upgrade.OnePerShip, 'card-factionFederation': upgrade.factionFederation, 'card-FrontArc': upgrade.FrontArc, 'card-RearArc': upgrade.RearArc, 'card-Hull': upgrade.Hull, 'card-mirror': upgrade.mirror, 'dragging': upgrade == dragStore.item }\" draggable drag-item=\"upgrade\" drag-store=\"dragStore\" drag-source=\"dragSource\">\n" +
    "\n" +
    "\t<div class=\"card-image\"></div>\n" +
    "\n" +

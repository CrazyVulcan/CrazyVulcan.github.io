angular.module('utopia').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('fleet-export.html',
    ...
    "\n" +
    "\t<label class=\"export-option\"><input type=\"checkbox\" ng-model=\"ttsExportStyle\">Table-Top Sim Export</label>\r" +
    "\n" +
    "\t<textarea class=\"export-text\" ng-model=\"fleetText\"></textarea>\r" +
    "\n" +
    "\t<!-- <div class=\"u-search-header\"><div class=\"u-search-header-text\">Tabletop Simulator Export</div></div>\r" +
    "\n" +
    "\t<textarea name=\"tts-export-text-area\" class=\"export-text\" ng-model=\"ttsText\"></textarea> -->\t\r" +
    "\n" +
    "\t\r" +
    "\n" +
    "</div>\r" +

			...
			upgradeSlots: cloneSlot( 2 ,
				{
					...
					intercept: {
						ship: {
							cost: function(upgrade,ship,fleet,cost) { 
							if ( ship && $factions.hasFaction( ship, "federation", ship, fleet ) ? 0 : 1 && $factions.hasFaction( ship, "bajoran", ship, fleet ) ? 0 : 1 && $factions.hasFaction( ship, "vulcan", ship, fleet ) ? 0 : 1)
								cost = 3;
							return cost;
							}
						}

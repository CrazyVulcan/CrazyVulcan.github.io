			...
			intercept: {
				ship: {
					cost: {
						...
						priority: 100,
						fn: function(upgrade,ship,fleet,cost) {
							if( slot.occupant.type == "weapon" && upgrade.name != "Torpedo Fusillade" && upgrade.name != "Dorsal Phaser Array" && upgrade.name != "Aft Phaser Emitters" && upgrade.name != "Particle Beam Weapon") {

...
module.factory( "cardRules", [ "$filter", "$factions", function($filter, $factions) {
	...
	//U.S.S. Defiant : 71268
		"captain:2030":{
			factionPenalty: function(upgrade,ship,fleet) {
				return ship && $factions.hasFaction(ship,"vulcan", ship, fleet) ? 0 : 1 && $factions.hasFaction(ship,"federation", ship, fleet) ? 0 : 1;
			}
		},
		"captain:2029":{
			factionPenalty: function(upgrade,ship,fleet) {
	...
	//Red Shirt Crew : OP2Participation
		"crew:3091":{
			factionPenalty: function(upgrade,ship,fleet) {
				return ship && $factions.hasFaction(ship,"vulcan", ship, fleet) ? 0 : 1 && $factions.hasFaction(ship,"bajoran", ship, fleet) ? 0 : 1;
			}
	...
	//Flagship Resource : OP4Participation
		"resource:4004": {
			slotType: "flagship",
			cost: 0,
			hideCost: true,
		...
		"flagship:6007": {
			// Only equip if ship matches faction
			canEquip: function(upgrade,ship,fleet) {
				return $factions.hasFaction(ship, "federation", ship, fleet) && $factions.hasFaction(ship, "vulcan", ship, fleet) && $factions.hasFaction(ship, "bajoran", ship, fleet);
			}
		},
	...
	//D'Kyr : 71446
		"captain:vulcan_captain_71446":{
			factionPenalty: function(upgrade,ship,fleet) {
				return ship && $factions.hasFaction(ship,"federation", ship, fleet) ? 0 : 1 && $factions.hasFaction(ship,"bajoran", ship, fleet) ? 0 : 1;
			}
		},
		"captain:tavek_71446": {
			factionPenalty: function(upgrade,ship,fleet) {
	...
	//Soong : 71522
		...
		"crew:bosus_71522":{factionPenalty: function(upgrade,ship,fleet) {
				return ship && $factions.hasFaction(ship,"ferengi", ship, fleet) ? 0 : 1 && $factions.hasFaction(ship,"kazon", ship, fleet) ? 0 : 1 && $factions.hasFaction(ship,"xindi", ship, fleet) ? 0 : 1
			}
		},
		"crew:crosis_71522":{
	...
	//Enterprise NX-01 : 71526
		...
		"crew:t_pol_71526": {
			...
			factionPenalty: function(upgrade,ship,fleet) {
				return $factions.hasFaction( ship, "vulcan", ship, fleet ) ? 0 : 1 && $factions.hasFaction(ship,"bajoran", ship, fleet) ? 0 : 1;
			}
		},
		...
		"weapon:aft_phase_cannon_71526":{
			factionPenalty: function(upgrade,ship,fleet) {
				return ship && $factions.hasFaction(ship,"vulcan", ship, fleet) ? 0 : 1 && $factions.hasFaction(ship,"bajoran", ship, fleet) ? 0 : 1;
			}
		},
		"weapon:photonic_torpedoes_71526":{
			factionPenalty: function(upgrade,ship,fleet) {
				return ship && $factions.hasFaction(ship,"vulcan", ship, fleet) ? 0 : 1 && $factions.hasFaction(ship,"bajoran", ship, fleet) ? 0 : 1;
			}
		},
	...
	//Fina Prime : 71534
		...
		"crew:vidiian_boarding_party_71534":{
			factionPenalty: function(upgrade,ship,fleet) {
				return ship && $factions.hasFaction(ship,"ferengi", ship, fleet) ? 0 : 1 && $factions.hasFaction(ship,"kazon", ship, fleet) ? 0 : 1 && $factions.hasFaction(ship,"xindi", ship, fleet) ? 0 : 1
			}
		},
	...
	//U.S.S. Hood : 71998p
		...
		"tech:tachyon_detection_grid_71998p":{
			factionPenalty: function(upgrade,ship,fleet) {
				return ship && $factions.hasFaction(ship,"vulcan", ship, fleet) ? 0 : 1 && $factions.hasFaction(ship,"bajoran", ship, fleet) ? 0 : 1;
			}
		},
	...
	//U.S.S. Dauntless : 71805
		...
		"talent:emergency_shutdown_71805":{
			factionPenalty: function(upgrade,ship,fleet) {
				return ship && $factions.hasFaction(ship,"ferengi", ship, fleet) ? 0 : 1 && $factions.hasFaction(ship,"kazon", ship, fleet) ? 0 : 1 && $factions.hasFaction(ship,"xindi", ship, fleet) ? 0 : 1
			}
		},
	...
	//U.S.S. Bellerophon : 72001p
		...
		"crew:luther_sloan_72001p": {
			factionPenalty: function(upgrade,ship,fleet) {
				return ship && $factions.hasFaction(ship,"federation",ship,fleet) && $factions.hasFaction(ship,"ferengi", ship, fleet) ? 0 : 1 && $factions.hasFaction(ship,"kazon", ship, fleet) ? 0 : 1 && $factions.hasFaction(ship,"xindi", ship, fleet) ? 0 : 1
			}
		},
	...
	//IKS Heghta
		"tech:auxiliary_power_to_shields_72281p":{
			rules: "Only one per ship",
			canEquip: d("Auxiliary Power To Shields")
		},
		"talent:change_course_72281p_talent":{
			rules: "Only one per ship",
			canEquip: d("Course Change")
		},
	...
	//Selas Warbird
		"talent:klingon_romulan_alliance_72282gp":{
			factionPenalty: function (a, c, d) {
				return c && b.hasFaction(c, "klingon", c, d) ? 0 : 1 && b.hasFaction(c, "romulan", c, d) ? 0 : 1
			}
		},
		"tech:tachyon_pulse_72282gp":{
			rules: "Only one per ship",
			canEquip: d("Tachyon Pulse")
		},
	...
	//Calindra
		...
		"talent:retaliation_72281":{
			canEquipFaction: function (a, c, d) {
				return c.captain && b.hasFaction(c.captain, "xindi", c, d)
			}
		},
		"crew:raijin_72281":{
			factionPenalty: function (a, c, d) {
		...
		"tech:biometric_hologram_72281":{
			...
			rules: "Only one per ship",
			canEquip: d("Biometric Hologram")
		},
		"tech:subspace_vortex_72281":{
			factionPenalty: function (a, c, d) {
				return c && b.hasFaction(c, "ferengi", c, d) ? 0 : 1 && b.hasFaction(c, "kazon", c, d) ? 0 : 1 && b.hasFaction(c, "independent", c, d) ? 0 : 1
			},
			canEquip: d("Subspace Vortex"),
			intercept: {
				self: {
		...
		"tech:trellium_d_72281":{
			...
			canEquip: d("Trellium-D"),
			intercept: {
				self: {
					cost: function (a, b, c, d) {
						return b && !h(b, "xindi", b, c) ? g(a, b, c, d) + 4 : d
					}
				}
			}
		},
		
	//Yesterdays Enterprise-D	
		...
		"talent:dispersal_pattern_sierra_72284p":{
			factionPenalty: function (a, c, d) {
				return c && b.hasFaction(c, "vulcan", c, d) ? 0 : 1 && b.hasFaction(c, "bajoran", c, d) ? 0 : 1
			}
		},
			...
			intercept: {
				self: {
					attack: function (a, b, d, e) {
						return b ? c(b, "attack", b, d) - 1 : e
					},
					cost: function (a, b, d, e) {
						return b ? g(a, b, d, e) + c(b, "attack", b, d) : e
					}
				}
			}
		},
	...
	//Muratas	
		...
		"tech:thermal_chamber_muratas":{
			...
			canEquip: function (a, b, c) {
				return b && "Xindi Reptilian Warship" == b["class"]
			}
		},
	...
	//IKS Ves Batlh
				...
				intercept: {
					ship: {
						...
						canEquip: function (a, c, d, e) {
							return b.hasFaction(a, "klingon", c, d) ? e : !1
						}
					}
				}
			}),
		...
		"crew:bounty_hunter_72012wp":{
			factionPenalty: function (a, c, d) {
				return c && b.hasFaction(c, "ferengi", c, d) ? 0 : 1 && b.hasFaction(c, "kazon", c, d) ? 0 : 1 && b.hasFaction(c, "xindi", c, d) ? 0 : 1
			}
		},
	...
	//Dreadnought
		...
		"weapon:plasma_wave_72013wp":{
			canEquip: function (a, b, c) {
				return b && "Cardassian ATR-4107" == b["class"]
			}
		},
		"weapon:thoron_shock_emitter_72013wp":{
			canEquip: function (a, b, c) {
				return b && "Cardassian ATR-4107" == b["class"]
			}
		},
